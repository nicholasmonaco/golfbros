...
public class MenuScreen_Lobby : MenuScreen {
    ...
    public override void OnExit() {
        Server.Singleton.OnPlayer_Join -= PlayerListPopulator.AddPlayerEntry; // if we want to use this same thing in the actual game, we should make this remove when this detects server disconnect instead
        Server.Singleton.OnPlayer_Leave -= PlayerListPopulator.RemovePlayerEntry;
    }
